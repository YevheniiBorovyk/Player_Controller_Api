...
import static com.interview.utils.AllureAttachment.txtAttachment;
import static com.interview.utils.DateTimeUtils.getCurrentDateTime;
...
public class HTTPLoggerInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String requestStartTime = getCurrentDateTime("yyyy-MM-dd HH:mm:ss");

        Response response = proceedRequest(chain, threadName, allLogs, attachmentName, request);
        long tookMs = TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - startNs);
        String requestFinishTime = getCurrentDateTime("yyyy-MM-dd HH:mm:ss");
